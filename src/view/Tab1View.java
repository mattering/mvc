...
public class  Tab1View{
    ...
    public JRadioButton y1 = new JRadioButton("y=ax+b+c");
    public JRadioButton y2 = new JRadioButton("y=ax^2+bx-c");
    public JRadioButton y3 = new JRadioButton("y=ax^3+bx^2+c");

    public JTextField xStartField = new JTextField("0");
    public JTextField xEndField = new JTextField("5");
    JTextField fileName = new JTextField("Type text name");

    public JTextField af = new JTextField("1");
    public JTextField bf = new JTextField("2");
    public JTextField cf = new JTextField("-2");
    public JTextField stepf = new JTextField("0.0001");
    public DisplayGraphics g = new DisplayGraphics() ;
    public JButton findR = new JButton("Find root");
    public JButton findR2 = new JButton("Find Root 2");
